...
#### B. Testez les modèles suivants Auto-Encodeurs, VAE, Random-Forest, SVM (Suppport Vector Machine), et la régression linéaire pour la prédiction de l'expression de tous les gènes des jeux de données. Quels sont les paramètres utilisés? 
